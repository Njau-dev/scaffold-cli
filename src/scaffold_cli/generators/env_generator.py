...
class EnvGenerator:
    ...
    def interactive_setup(self) -> bool:
        ...
        # Ask about services
        if questionary.confirm("Would you like to configure additional services?", default=True).ask():
    ...
    def _add_service_vars(self, category: str, service: str):
        ...
        console.print(
            f"[green]✓[/green] Added {service.upper()} configuration")
    ...
    def generate_files(self) -> bool:
        ...
        try:
            ...
            if env_path.exists():
                if not questionary.confirm(".env already exists. Overwrite?", default=False).ask():
